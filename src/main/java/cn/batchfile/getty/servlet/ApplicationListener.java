...
public class ApplicationListener {
	...
	public static final String CONFIG_FILE = "_application.groovy";
	...
	public ApplicationListener(Configuration configuration, Application application) {
	...
	public void start() throws IOException {
		LOG.debug("run application start script");
		runScripts(files, "start");
	}
	
	public void stop() throws IOException {
		LOG.debug("run application stop script");
		runScripts(files, "stop");
	}
	
	private void runScripts(List<File> files, String method) throws IOException {
		for (File file : files) {
			LOG.info("run script: " + file.getAbsolutePath());
			runScript(file, method);
		}
	}

	private void runScript(File file, String method) throws IOException {
